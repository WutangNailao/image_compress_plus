...
import world.nailao.image_compress_plus.core.CompressFileHandler
import world.nailao.image_compress_plus.core.CompressListHandler
import world.nailao.image_compress_plus.format.FormatRegister
import world.nailao.image_compress_plus.handle.common.CommonHandler
import world.nailao.image_compress_plus.handle.heif.HeifHandler
...
class ImageCompressPlugin : FlutterPlugin, MethodCallHandler {
    ...
    override fun onAttachedToEngine(binding: FlutterPlugin.FlutterPluginBinding) {
        ...
        channel = MethodChannel(binding.binaryMessenger, "image_compress_plus")
