...
class ImageCompressPlusHostApi {
  ...
  Future<Uint8List> compressWithList({required Uint8List image, int targetWidth = 1920, int targetHeight = 1080, int quality = 95, int rotate = 0, bool autoCorrectionAngle = true, HostFormat targetFormat = HostFormat.jpeg, bool keepExif = false, }) async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.image_compress_plus_ios.ImageCompressPlusHostApi.compressWithList$pigeonVar_messageChannelSuffix';
  ...
  Future<void> showLog(bool value) async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.image_compress_plus_ios.ImageCompressPlusHostApi.showLog$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
